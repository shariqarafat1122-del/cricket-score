...
export async function fetchLivescore(
  ...
  // NOTE: Cricbuzz blocks direct browser requests (CORS + no public API key).
  // In production, proxy this through your backend or a CORS proxy.
  // Example proxy: https://corsproxy.io/?https://www.cricbuzz.com/api/mcenter/livescore/{matchId}
  const url = `https://corsproxy.io/?https://www.cricbuzz.com/api/mcenter/livescore/${matchId}`;
